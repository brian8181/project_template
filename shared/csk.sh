...
CLASS_TEMPLATE_PATH="${USER_ROOT}/bin/class_tmpl"
PROJECT_PATH=$DEFAULT_PROJECT_PATH/$APP_NAME

echo "USER_NAME : $USER_NAME"
echo "APP_NAME : $APP_NAME"
echo "USER_ROOT : $USER_ROOT"

#echo DEBUG ${APP_NAME:=$DEFAULT_APP_NAME} ${TEMPLATE_PATH:=$DEFAULT_TEMPLATE_PATH} ${PROJECT_PATH:=$DEFAULT_PROJECT_PATH}
~/bin/skel.sh ${APP_NAME} ${TEMPLATE_PATH} ${PROJECT_PATH} 
